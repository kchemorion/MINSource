Contributing to MINS
===============================

There are many ways to contribute to MINS.

  * Submit a feature request or bug, or add to the discussion on the [MINS issue tracker][is]
  * Submit a [Pull Request][pr] to improve MINS.
...
If you are new to MINS development and you don't have push access to the MINS
...
When submitting a PR, make sure to add a `Cc: @DISC4ALL/developers` comment to
notify MINS developers of your awesome contributions. Based on the
...
* You do NOT have push access: A MINS core developer will integrate your PR.
...
[pr]: https://github.com/DISC4ALL/DISC4ALL/merge_requests
[is]: https://github.com/DISC4ALL/DISC4ALL/issues
